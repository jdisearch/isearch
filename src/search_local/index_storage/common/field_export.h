 ...
 * =====================================================================================
 *
 *       Filename:  field_export.h
 *
 *    Description:  field: column value of table
 * 					FieldSet: set of field
 * 					field_value: set of combo(field, oper, type, value)
 ...
 * 					DTCResultSet: some RowValue, subtable result received from server/helper
...
public:
	...
	void *table_definition(void) const { return ref; }
	void *ref;
	int num_fields() const { return 255; }
};
...
public:
	...
	void update_type_mask_ro(int ro) { typeMask |= (ro ? 1 : 2); };
	void update_type_mask_sync(int sy) { typeMask |= (sy ? 4 : 8); };
	int has_type_ro(void) const { return typeMask & 1; }
	int has_type_rw(void) const { return typeMask & 2; }
	int has_type_sync(void) const { return typeMask & 4; }
	int has_type_async(void) const { return typeMask & 8; }
