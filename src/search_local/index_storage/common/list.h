...
public:
	...
	inline void InitList(void) { INIT_LIST_HEAD(&objlist); }
	inline void ResetList(void) { list_del_init(&objlist); }
	inline int ListEmpty(void) const { return list_empty(&objlist); }
	inline ListHead *ListNext(void) { return list_entry(objlist.next, ListHead, objlist); }
	inline ListHead *ListPrev(void) { return list_entry(objlist.prev, ListHead, objlist); }

	inline void ListAdd(ListHead &n) { list_add(&objlist, &n.objlist); }
	inline void ListAdd(ListHead *n) { list_add(&objlist, &n->objlist); }
	inline void ListAddTail(ListHead &n) { list_add_tail(&objlist, &n.objlist); }
	inline void ListAddTail(ListHead *n) { list_add_tail(&objlist, &n->objlist); }
	inline void list_del(void) { ResetList(); }
	inline void ListMove(ListHead &n) { list_move(&objlist, &n.objlist); }
	inline void ListMove(ListHead *n) { list_move(&objlist, &n->objlist); }
	inline void list_move_tail(ListHead &n) { _list_move_tail(&objlist, &n.objlist); }
	inline void list_move_tail(ListHead *n) { _list_move_tail(&objlist, &n->objlist); }
...
class ListObject : public ListHead
{
public:
	inline ListObject(void) { InitList(); }
	inline ~ListObject(void) { ResetList(); }
	inline ListObject<T, I> *ListNext(void) { return (ListObject<T, I> *)ListHead::ListNext(); }
	inline ListObject<T, I> *ListPrev(void) { return (ListObject<T, I> *)ListHead::ListPrev(); }
	// inline T *ListOwner(void) { return static_cast<T *>(this); }
	inline T *ListOwner(void) { return (T *)this; }
	inline T *NextOwner(void) { return ListNext()->ListOwner(); }
	inline T *PrevOwner(void) { return ListPrev()->ListOwner(); }
};
